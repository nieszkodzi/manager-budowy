...
description: Coding conventions, preferred implementations, and style guidelines.
disable-model-invocation: true
---

# Best Practices Guide

This document outlines the coding conventions, preferred implementations, and style guidelines.
...
2.  **Type Check**: `make type-check` (runs MyPy).
3.  **Test**: `make run-test`.
